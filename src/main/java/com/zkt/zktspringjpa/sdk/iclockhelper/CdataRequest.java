...
import com.zkt.zktspringjpa.sdk.Enum.TableEnum;
...
public class CdataRequest extends ZKRequest {
    ...
    public static CdataRequest fromReq(HttpExchange exchange) throws Exception, IOException {
        ...
        if (uri == null) {
            return new CdataRequest(sn[0], sn[1], requestMethod, "", false, "", "", "", TableEnum.UNKNOWN, null, null,
                    null, null);
        }

        if ("GET".equals(requestMethod)) {
            return new CdataRequest(sn[0], sn[1], requestMethod, "", true, "", "", "", TableEnum.UNKNOWN, null, null,
                    null, null);
        }
        ...
        if ("POST".equals(requestMethod)) {
            ...
            if (table == TableEnum.ATTPHOTO) {
                // attPhotoLog = AttendancePhotoLog.fromRequestPin(_fromMaps("PIN", "",
                // parsedReq.getParams()), body);
            }

            return new CdataRequest(sn[0], sn[1], requestMethod, "", false, "Br", stamp, operationStamp, table, attLog,
                    operLog, attPhotoLog, null);
        }

        return new CdataRequest(sn[0], sn[1], requestMethod, "", false, "", "", "", TableEnum.UNKNOWN, null, null, null,
                null);
    }
