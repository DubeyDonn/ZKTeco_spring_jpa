...
public class Fingerprint {
    ...
    public static Fingerprint fromStr(String line)
    ...
    private static <T> T fillDaFromMapping(Class<T> modelType, Map<String, String> mapping, Map<String, String> kwargs)
            throws IllegalArgumentException, IllegalAccessException, InstantiationException {
