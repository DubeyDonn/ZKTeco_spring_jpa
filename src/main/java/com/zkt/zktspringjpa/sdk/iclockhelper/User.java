...
public class User {
    ...
    public User(String pin, String name, String password, String card, String group, String tz, String privileges,
            String raw, String verify, String viceCard) {
        this.pin = pin;
        this.name = name;
    ...
    private static Map<String, String> buildDict(String line) {
        ...
        // (You can use a library like Jackson or Gson for JSON parsing in a real-world
        // scenario)
        return new HashMap<>();
    }

    private static <T> User fillDaFromMapping(Class<User> class1, String string, Map<String, String> kwargs)
