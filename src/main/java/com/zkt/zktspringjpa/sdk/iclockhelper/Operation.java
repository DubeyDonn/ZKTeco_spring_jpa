...
import com.zkt.zktspringjpa.sdk.Enum.AlarmEnum;
import com.zkt.zktspringjpa.sdk.Enum.OperationEnum;
...
public class Operation extends ServerDatetimeMixin {
    ...
    public Operation(String object, String param1, String param2, String param3, String raw, OperationEnum operation,
            String admin, AlarmEnum alarm) {
        super(null);
        this.object = object;
        this.param1 = param1;
        this.param2 = param2;
