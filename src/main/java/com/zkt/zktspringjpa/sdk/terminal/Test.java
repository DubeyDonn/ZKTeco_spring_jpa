...
public class Test {
        ...
        public static void main(String[] args) throws Exception {
                ZKTerminal terminal = new ZKTerminal("192.168.0.50", 4370);
                ...
                // reply = terminal.setSms(253,1024,7680,System.currentTimeMillis(),"Dhana
                // Test");
                ...
                //
                // System.out.println("tag: " + smsinfo.getTag()); // 253 public , 254 private ,
                // 255 draft
                // System.out.println("ID: " + smsinfo.getId()); // 1 - 256 2 - 512 3 - 768 (id
                // * 256)
                // System.out.println("validMinutes: " + smsinfo.getValidMinutes()); // (min *
                // 256)
                ...
                // terminal.getAttendanceRecordsForDateRange("2024-02-21 00:00:00", "2024-02-21
                // 23:59:00");
                //
                // // Access and print user information
                ...
                // Update
                // UserInfo user = new UserInfo(83,"83", "Gokul G", "6567",
                // UserRole.USER_DEFAULT, 2111);
                ...
                // terminal.getDeviceStatus().get("userCapacity"));
