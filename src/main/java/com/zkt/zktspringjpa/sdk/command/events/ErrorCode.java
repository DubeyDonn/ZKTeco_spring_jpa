package com.zkt.zktspringjpa.sdk.command.events;
...
public enum ErrorCode {
    ...
    DATA_EXCEPTION_SMALLER_THAN_OR_EQUAL_TO_0(15114,
            "A data exception is returned as the number of fields is smaller than or equal to 0"),
    DATA_EXCEPTION_INCONSISTENT_TOTAL_NUMBER_OF_TABLE_FIELDS(15115,
            "A data exception is returned as the total number of table fields is inconsistent with the total number of fields of the data"),
